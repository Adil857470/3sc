...
class SalesOrder(models.Model):
    ...
    warehouse_Code=models.CharField(max_length=100,null=True,blank=True)
...
class MSL_report(models.Model):
    ...
    TenantId = models.ForeignKey(Tenant,blank=True,null=True,on_delete=models.CASCADE) 
    BUId = models.ForeignKey(BU,blank=True,null=True,on_delete=models.CASCADE)
    BranchId = models.ForeignKey(Branch,blank=True,null=True,on_delete=models.CASCADE)
    SKUId = models.ForeignKey(SKU_SNP,blank=True,null=True,on_delete=models.CASCADE) 
    SKU_Code = models.CharField(max_length=200,blank=True,null=True) 
    DivisionId = models.ForeignKey(Division,blank=True,null=True,on_delete=models.CASCADE) 
    CategoryId = models.ForeignKey(Category,blank=True,null=True,on_delete=models.CASCADE)
    BrandId = models.ForeignKey(Brand,blank=True,null=True,on_delete=models.CASCADE)
    ...
    CreatedDate = models.DateTimeField(auto_now=True) 
    CreatedBy = models.ForeignKey(ScmUser,blank=True,null=True,on_delete=models.CASCADE) 
